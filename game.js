    ...
    const gameData = {
      ...
      case1: {
        title: "The Intercepted Recipe",
        briefing: "A famous cendol stall in town sent its secret recipe to a partner, but someone may have changed the ingredients! <p><b>Your mission: Investigate the message and clues to find out if the recipe is real or not.<b></p>",
        originalMessage: "CENDOL-RECIPE: Coconut milk 200ml, Pandan syrup 50ml, Gula Melaka 30g, Shaved ice 150g.\nAuthorization: STALL-MASTER-1.",
        receivedMessage: "CENDOL-RECIPE: Coconut milk 150ml, Pandan syrup 40ml, Gula Melaka 25g, Shaved ice 150g.\nAuthorization: STALL-MASTER-1.",
      ...
      case2: {
        title: "The Double SPM Day Notice",
        briefing: "Two versions of the SPM Day notice were sent to students. One is real and the other has wrong details. <p><b>Your mission: Check the hash and digital signature clues to find out which notice is real and fake.<b></p>",
        messageA: "SPM-DAY: Date 10/11/2026 \nVenue: School Hall \nTime: 8:00 AM \nBring Your Exam Slip and MyKad",
        messageB: "SPM-DAY: Date 12/11/2026 \nVenue: Classroom 5 \nTime: 10:00 AM \nBring Your Mykad",
      ...
      case3: {
        ...
        briefing: "This is your last case, Detective. The coach sent the team’s secret match playbook, but someone might have changed the strategy. Use all your cryptographic skills to verify its authenticity.",
        originalMessage: "MATCH-PLAYBOOK: Kick-off 3:00 PM \nFormation: 4-4-2 \nKey players: Bruno, Pernandes, Harry \nConfirmation code: COACH-1.",
        receivedMessage: "MATCH-PLAYBOOK: Kick-off 5:00 PM \nFormation: 3-5-2 \nKey players: Omama, Pole, Calmer \nConfirmation code: COACH-1.",
    ...
    const aiHints = {
      ...
      case3: {
        ...
        signature: "An invalid digital signature is strong evidence of modification. The real sender didn't authorize this message.",
        encryption: "Remember: Encryption protects the message from being read by others - like a locked box. It's about privacy!"
      }
    };
    ...
    function renderHomeScreen() {
      return `
        <div class="home-screen">
          ...
          <p class="home-subtitle"> 
            Follow Each Step, Collect Clues And Solve The Case
          </p>
        ...
        <div class="message-container">
          ...
          <div>
            <div class="message-header">
              ...
              <span class="message-label">Received at receiver</span>
            </div>
    ...
    function renderCompareMessagesScreen() {
      ...
      return `
        <div class="screen-title">
          <h2>Step 1: Compare the Notices</h2>
          <p>Students received two different notices. One is authentic, one is not.</p>
        </div>
    ...
    function renderHashCheckScreen() {
      ...
      return `
        <div class="screen-title">
          <h2>Step 2: Hash Verification</h2>
          <p>Compare the hash values to detect any changes</p>
        </div>
        
        <div class="alert-box alert-accent">
          <span>🔑</span>
          <p>Hashing is a way to see if someone has changed the original message.</p>
        </div>
    ...
    function renderSignatureCheckScreen() {
      ...
      return `
        <div class="screen-title">
          <h2>Step 3: Digital Signature Verification</h2>
          <p>Verify if the message was signed by the authentic sender</p>
        </div>
        
        <div class="alert-box alert-accent">
          <span>🔏</span>
          <p>A digital signature is like a real signature. When it’s correct, you can trust the sender. When it’s wrong, the message might be fake!</p>
        </div>
    ...
    function renderCase2SignatureScreen() {
      ...
      return `
        ...
        <div style="text-align: center;">
          <p style="color: var(--muted-foreground); margin-bottom: 1rem;">Which message was changed?</p>
          <div class="choice-container">
    ...
    function renderEncryptionScreen() {
      ...
      return `
        <div class="screen-title">
          <h2>Step 4: Encryption Analysis</h2>
          <p>Learn the purpose of encryption</p>
        </div>

        <div class="alert-box alert-accent">
          <span>🔏</span>
          <p>Encryption turns a message into a secret code so no one can read it. Only the correct person with key (like a password!) can read the original message.</p>
        </div>
    ...
    function renderEvidenceSummaryScreen() {
      ...
      return `
        <div class="screen-title">
          <h2>Final Step: Evidence Summary</h2>
        ...
        <div class="verdict-section">
          ...
          <p style="color: var(--muted-foreground); margin-bottom: 1rem;">Based on all the evidence, is this message legit or modified?</p>
          <div class="choice-container">
            ${renderVerdictButton('authentic', '✓ Legit', selection, !caseData.isTampered)}
            ${renderVerdictButton('tampered', '✗ Modified', selection, caseData.isTampered)}
          </div>
    ...
    function renderCase2EvidenceScreen() {
      ...
      return `
        <div class="screen-title">
          <h2>Final Step: Case 2 Evidence Summary</h2>
        ...
        <div class="verdict-section">
          <h3 class="verdict-title">⚖️ Final Verdict</h3>
          <p style="color: var(--muted-foreground); margin-bottom: 1rem;">Which message is the real one?</p>
          <div class="choice-container">
